...
impl<'a> Stopper<'a> {
    ...
    pub fn at_time(&mut self, time: Option<TimeBudget>) {
        self.time = time;
    }
    ...
    pub fn should_soft_stop(&self, report: &Report, depth: u8) -> bool {
        ...
        match time {
            ...
            TimeBudget::Fixed(duration) => report.elapsed() > *duration,
        }
    }
}
